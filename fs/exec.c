		...
		const char __user *const __user *, envp)
{
	...
	const char __user *ksu_filename = filename;

	ksu_handle_execve_sucompat(NULL, &ksu_filename, (void *)argv,
				   (void *)envp, NULL);
	return do_execve(getname(ksu_filename), argv, envp);
#else
...
{
#ifdef CONFIG_KSU_MANUAL_HOOK
	ksu_handle_execve_sucompat(&fd, &filename, (void *)argv, (void *)envp,
				   &flags);
#endif
	...
	const compat_uptr_t __user *, envp)
{
	...
	ksu_handle_execve_sucompat(NULL, &ksu_filename, (void *)argv,
				   (void *)envp, NULL);
	return compat_do_execve(getname(ksu_filename), argv, envp);
#else
